...
def sym_matrix_antiminors_subspace(dim):
    ...
    for col_key in it.combinations_with_replacement(
        ...
        # w0 = 1 if row_key[0] == row_key[1] else np.sqrt(2)
        # w1 = 1 if row_key[0][0] == row_key[0][1] else np.sqrt(2)
        # w2 = 1 if row_key[1][0] == row_key[1][1] else np.sqrt(2)
        # vals.append((w0 * w1 * w2))
